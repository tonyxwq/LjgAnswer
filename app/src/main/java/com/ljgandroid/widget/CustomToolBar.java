 ...
 * Author:XWQ
 * Time   2019/1/16
 * Descrition: this is CustomToolBar
 */
...
public class CustomToolBar extends LinearLayout
{
    ...
    public void initView(AttributeSet attrs)
    {
        ...
        ImageView leftBtn =  barLayoutView.findViewById(R.id.toolbar_left_btn);
        ...
        ImageView rightBtn =  barLayoutView.findViewById(R.id.toolbar_right_btn);
